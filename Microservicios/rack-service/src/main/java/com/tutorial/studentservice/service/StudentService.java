...
public class StudentService {
    ...
    public List<Book> getBooks(int studentId) {
        List<Book> books = restTemplate.getForObject("http://localhost:8002/book/bystudent/" + studentId, List.class);
        return books;
    }

    public List<Pet> getPets(int studentId) {
        List<Pet> pets = restTemplate.getForObject("http://localhost:8003/pet/bystudent/" + studentId, List.class);
        return pets;
    }
